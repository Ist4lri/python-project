    ...
    def split(nameFile):
        ...
        if extension == 'gtf' or extension == 'gff':
            ...
            for key, value in mon_dict.items():
                outFile.write("Gene ID : " + key + "\tLenght :" + value + "\n")
        else:
            outFile.write('Utilisez fichiers format gtf')
        ...
        def fasta(file2):
            ...
            if extension == 'fasta':
                ...
                for key, value in mon_dict.items():
                    ...
                    Start2 = int(m2[0])
                    outFile.write(str(Start2))
                    End2 = int(m2[1])
                    outFile.write(str(End2))
                ...
                for key, value in mon_dict_fasta.items():
                    outFile.write("Transcript ID : " + key +
                                  "\tSequence :" + value + "\n")

            else:
                outFile.write("Utilisez fichiers format fasta")
